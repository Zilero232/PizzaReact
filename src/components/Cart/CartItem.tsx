...
import { CartItem as CartItemsType } from "../../redux/cart/types";
...
const CartItem: FC<CartItemProps> = ({ id, title, price, count, imageUrl, type, size }) => {
  const dispatch = useAppDispatch();

  const onClickPlus = () => {
    dispatch(addItem({ id } as CartItemsType));
  };
